...
set yla "runtime (ns)"
set xla "input size"
plot "0.csv" title "Bubble Sort", "1.csv" title "Better Bubble Sort", "2.csv" title "Best Bubble Sort", "3.csv" title "Cocktail Sort", "4.csv" title "Selection Sort", "5.csv" title "Merge Sort", "6.csv" title "Quicksort", "7.csv" title "Heapsort", "8.csv" title "Java default (Timsort)", "9.csv" title "Bogosort", "10.csv" title "Bozosort", 50 * x title "50 n", x*x title "n^2", x * x * x title "n^3", 10 * x * log(x) title "10 n log n"
